...
import ca.csf.dfc.a2018pooexamen01.mediatheque.LivrePoche;
...
public class DonneesTestsMediathequeRepository implements MediathequeRepository {
	...
	public List<Media> trouverMediaParExpression(String p_TexteExpression) {
		...
		return m_ListeMedia.stream().filter(m -> m.getTitre().toLowerCase().contains(texteExpression))
				.collect(Collectors.toList());
	}

	public DonneesTestsMediathequeRepository() {
		this.m_ListeMedia = Arrays.asList(new LivreBroche(1, "Les Fourmis"), new LivreBroche(2, "Le Jour des fourmis"),
				...
				new CompactDisk(21, "Angels Fall First"), new CompactDisk(22, "Oceanborn"),
				new CompactDisk(23, "Wishmaster"), new CompactDisk(24, "Century Child"), new CompactDisk(25, "Once"),
				new CompactDisk(26, "Dark Passion Play"), new CompactDisk(27, "Herzeleid"),
				new CompactDisk(28, "Sehnsucht"), new CompactDisk(29, "Mutter"), new CompactDisk(30, "Reise, Reise"),
				new CompactDisk(31, "Rosenrot"), new CompactDisk(32, "Liebe ist für alle da"),
				new LivrePoche(41, "Les Fourmis"), new LivrePoche(42, "Le Jour des fourmis"),
				new LivrePoche(43, "La Révolution des fourmis"), new LivrePoche(44, "Les Thanatonautes"));
	}
	...
	public List<Media> trouverMediaParExpressionEtType(String p_TexteExpression, String p_TypeMedia) {
		...
		if (p_TypeMedia != null && p_TypeMedia.compareTo("") != 0) {
			tmp = tmp.filter(m -> m.getType().compareToIgnoreCase(p_TypeMedia) == 0);
		}
